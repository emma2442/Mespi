...
class Programmation_compartiment_View_4(QWidget):
    def __init__(self, fenetre_3_prises, fenetre_selection, controller):
        super().__init__()

        self.fenetre_selection = fenetre_selection
        self.fenetre_3_prises = fenetre_3_prises
        ...
        self.label_prise_4 = QLabel("Prise n°4 :")
        self.label_prise_4.setStyleSheet("background-color : #0B848C ; border-radius: 10% ; padding: 5px ; color : white")
        self.label_prise_4.setFixedWidth(80)
        self.prise_4 = QLineEdit()
        self.prise_4.setPlaceholderText("00")
        self.prise_4.setMaximumWidth(25)
        self.prise_4.setStyleSheet("background-color : #C0DEE6 ; color : black")
        self.label_h_4 = QLabel("h")
    ...
    def init_ui(self):
        ...
        box_prise_4 = QHBoxLayout()
        box_prise_4.addWidget(self.label_prise_4)
        box_prise_4.addWidget(self.prise_4, 0, Qt.AlignLeft)
        box_prise_4.addWidget(self.label_h_4, 0, Qt.AlignLeft)
        box_prise_4.addSpacing(90)
        box_prise_4.addWidget(self.supp_prise)
        box_prise_4.setAlignment(Qt.AlignLeft)
        ...
        box_finale.addLayout(box_prise_4)
    ...
    def btn_ajout_prise(self):
        self.hide()
        self.programmation_medicament_5_prises.show()
    ...
    def btn_supp_prise(self):
        ...
        self.checkbox_dimanche.isChecked(), self.prise_1.text(), self.prise_2.text(), self.prise_3.text(), self.prise_4.text())
        self.myController.supp_prise()
        self.fenetre_3_prises.show()
        self.fenetre_3_prises.compartiment_selectionne(self.label_numero_compartiment.text())
        self.hide()
    ...
    def remplir(self, data_compartiment):
        try : 
                ...
                if data_compartiment[11] != None :
                    self.prise_4.setText(str(data_compartiment[11]))
...
class Programmation_compartiment_4_prises_Controller:
    ...
    def enregistrer(self, label_numero_compartiment, nom_medicament, lundi, mardi, mercredi, jeudi,
                        vendredi, samedi, dimanche, prise_1, prise_2, prise_3, prise_4):
...
class Programmation_compartiment_4_prises_Model:
        def __init__(self):
        ...
        def recupere_data_compartiment_m(self, id_compartiment):
                ...
                conn.close()
#                print("dans recupere de 4 prises")
#                print(data_compartiment)
        ...
        def enregistrer_m(self, id_compartiment, nom_medicament, lundi, mardi, mercredi, jeudi,
                ...
                "dimanche" :dimanche, "prise_1" :prise_1, "prise_2" :prise_2, "prise_3" :prise_3, "prise_4" :prise_4}
                cursor.execute("""
                INSERT OR REPLACE INTO compartiments(id_compartiment, medicament, lundi, mardi, mercredi, jeudi, vendredi, samedi,
                dimanche, prise_1, prise_2, prise_3, prise_4) VALUES(:id_compartiment, :medicament, :lundi, :mardi, :mercredi, :jeudi, :vendredi,
                :samedi, :dimanche, :prise_1, :prise_2, :prise_3, :prise_4)""", data)
                conn.commit()
                conn.close()
#                print("enregistré 4 prises")
#                print(data)
        ...
        def supp_prise_m(self):
                ...
                cursor = conn.cursor()
                prise_4 = None
                data = {"prise_4" :prise_4}
                cursor.execute("""REPLACE INTO compartiments(prise_4) VALUES(:prise_4)""", data,)
                conn.commit()
                conn.close()
