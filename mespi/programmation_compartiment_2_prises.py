...
class Programmation_compartiment_View_2(QWidget):
    def __init__(self, fenetre_1_prise, fenetre_selection, controller):
        super().__init__()

        self.fenetre_selection = fenetre_selection
        self.fenetre_1_prise = fenetre_1_prise
        ...
        self.programmation_medicament_3_prises = Programmation_compartiment_View_3(self, fenetre_selection, programmation_compartiment_3_prises_Controller)
    ...
    def init_ui(self):
        ...
        box_prise_2.addSpacing(90)
        box_prise_2.addWidget(self.supp_prise)
    ...
    def btn_ajout_prise(self):
        self.hide()
        self.programmation_medicament_3_prises.show()
        ...
        self.checkbox_dimanche.isChecked(), self.prise_1.text(), self.prise_2.text())
        self.programmation_medicament_3_prises.compartiment_selectionne(self.label_numero_compartiment.text())
    ...
    def btn_supp_prise(self):
        ...
        self.fenetre_1_prise.show()
        self.fenetre_1_prise.compartiment_selectionne(self.label_numero_compartiment.text())
        self.hide()
...
class Programmation_compartiment_2_prises_Controller:
    ...
    def enregistrer(self, label_numero_compartiment, nom_medicament, lundi, mardi, mercredi, jeudi,
                        vendredi, samedi, dimanche, prise_1, prise_2):
...
class Programmation_compartiment_2_prises_Model:
        def __init__(self):
        ...
        def recupere_data_compartiment_m(self, id_compartiment):
                ...
                prise_1, prise_2 FROM compartiments WHERE id_compartiment=?""", (id_compartiment,))
                data_compartiment = cursor.fetchone()
                conn.close()
#                print("dans recupere de 2 prises")
#                print(data_compartiment)
        ...
        def enregistrer_m(self, id_compartiment, nom_medicament, lundi, mardi, mercredi, jeudi,
                ...
                "dimanche" :dimanche, "prise_1" :prise_1, "prise_2" :prise_2}
                cursor.execute("""
                INSERT OR REPLACE INTO compartiments(id_compartiment, medicament, lundi, mardi, mercredi, jeudi, vendredi, samedi,
                dimanche, prise_1, prise_2) VALUES(:id_compartiment, :medicament, :lundi, :mardi, :mercredi, :jeudi, :vendredi,
                :samedi, :dimanche, :prise_1, :prise_2)""", data)
                conn.commit()
                conn.close()
#                print("enregistré 2 prises")
#                print(data)
        ...
        def supp_prise_m(self):
                ...
                cursor = conn.cursor()
                prise_2 = None
                data = {"prise_2" :prise_2}
                cursor.execute("""REPLACE INTO compartiments(prise_2) VALUES(:prise_2)""", data,)
                conn.commit()
                conn.close()
