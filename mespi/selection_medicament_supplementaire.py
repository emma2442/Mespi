...
class Selection_medicament_supplementaire_View(QWidget):
    def __init__(self, fenetre_accueil, selection_compartiment_Model):
        ...
        self.label = QLabel("Appuyez sur un numéro pour \n entrer un médicament")
        ...
        self.setWindowTitle("médicament supplémentaire")
